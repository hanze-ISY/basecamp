...
public class BattleshipBoard {
    ...
    private final int[] remainingShips = {1, 1, 1, 1}; // One ship of each size: 2, 3, 4, 6 (For ship placement)
    private final int[] opponentShips = {1, 1, 1, 1}; //For tracking opponent ships by AI
    private final int[] playerShips = {1, 1, 1, 1}; //For tracking player ships
    private boolean shipsPlaced = false;
    private final Map<Integer, int[]> shipPositions = new HashMap<>();
    ...
    public boolean gameOver() {
        return playerShips[0] == 0 && playerShips[1] == 0 && playerShips[2] == 0 && playerShips[3] == 0;
    }
    ...
    private boolean validMove(int move) {
        ...
        return oppBoard[move] != 'X' && oppBoard[move] != 'O';
    }
